...
const Checkout = () => {
  ...
  const handleApplyCoupon = async () => {
    ...
    try {
      ...
      setCouponError(err.response?.data?.error?.message || err.response?.data?.message || 'Invalid or expired coupon');
              ...
              <div className="p-6 space-y-4">
                ...
                <div className="mb-6 pb-6 border-b border-gray-100">
                  <h3 className="text-sm font-semibold text-gray-800 flex items-center gap-2 mb-3">
                    <Tags size={16} className="text-[#88013C]" />
                    ...
                    <div className="space-y-2">
                      <div className="flex gap-2">
                        <input
                          ...
                          className="flex-1 px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-[#88013C] focus:border-transparent outline-none uppercase"
                          disabled={isApplyingCoupon}
                        />
                        <button
                          onClick={handleApplyCoupon}
                          disabled={!couponCode.trim() || isApplyingCoupon}
                          className="bg-[#88013C] hover:bg-[#a8014a] disabled:bg-gray-300 disabled:cursor-not-allowed text-white px-4 py-2 rounded-lg font-medium transition-colors"
                        >
